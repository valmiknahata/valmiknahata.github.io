    ...
    <div style={{ width: "100%", minHeight: "100vh", background: "transparent", color: "#000000" }}>
      <section className="section-essay" style={{ padding: "80px 60px", maxWidth: "925px", margin: "0 auto", width: "925px", boxSizing: "border-box" }}>
        <div style={{ fontSize: "18px", lineHeight: 1.9, color: "#1a1a1a", fontFamily: "'Crimson Text', serif" }}>
          ...
          <p className="bio" style={{ margin: "0 0 1.33em 0" }}>I'm Valmik, an undergraduate student and researcher at <a href="https://ucsd.edu" target="_blank" rel="noopener" data-preview="ucsd.edu">UC San Diego</a> studying Data Science, with a focus on building AI systems that are both powerful and aligned. I'm a research affiliate at <a href="https://www.massgeneral.org" target="_blank" rel="noopener" data-preview="massgeneral.org">Mass General</a> &amp; <a href="https://hms.harvard.edu" target="_blank" rel="noopener" data-preview="hms.harvard.edu">Harvard Medical School</a> working on clinical AI systems, a member of <a href="https://aialignment.mit.edu" target="_blank" rel="noopener" data-preview="aialignment.mit.edu">MIT AI Alignment</a>, and a UCSD Poseidon Fellow. Before that, as a research intern at <a href="https://www.dartmouth-hitchcock.org" target="_blank" rel="noopener" data-preview="dartmouth-hitchcock.org">Dartmouth Hitchcock Medical Center</a> &amp; <a href="https://www.dartmouth-health.org" target="_blank" rel="noopener" data-preview="dartmouth-health.org">Dartmouth Health</a>, I presented on an optimized retrieval system for pathology reports. My work has been recognized by <a href="https://www.apartresearch.com" target="_blank" rel="noopener" data-preview="apartresearch.com">Apart Research</a> &amp; <a href="https://bluedot.org" target="_blank" rel="noopener" data-preview="bluedot.org">BlueDot Impact</a>, <a href="https://ucsd.edu" target="_blank" rel="noopener" data-preview="ucsd.edu">UCSD</a> &amp; <a href="https://www.nsf.gov" target="_blank" rel="noopener" data-preview="nsf.gov">NSF</a>, and the <a href="https://www.nba.com/bucks" target="_blank" rel="noopener" data-preview="nba.com">Milwaukee Bucks</a>, among others. My research interests are AI × bio and AI safety.</p>
