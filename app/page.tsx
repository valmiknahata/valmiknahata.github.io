      ...
      <section className="section-essay" style={{ padding: "24px 60px 80px 60px", maxWidth: "925px", margin: "0 auto", width: "925px", boxSizing: "border-box" }}>
        <div style={{ fontSize: "18px", lineHeight: 1.9, color: "#1a1a1a", fontFamily: "'Crimson Text', serif" }}>
          ...
          <p style={{ margin: "1.56em 0" }}>
            <LinkPreview href="/philosophy" domain="valnahata.me" linkStyle={{ textDecoration: "none", color: "#1a1a1a" }}>
              &rarr; My philosophy, my <em>why</em>
            </LinkPreview>
          </p>

          <div className="social-links" style={{ display: "flex", gap: "20px", alignItems: "center", justifyContent: "center", margin: "2em 0 2.5em 0" }}>
