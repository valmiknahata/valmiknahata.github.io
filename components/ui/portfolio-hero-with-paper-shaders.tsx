        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-14 leading-7 opacity-85 text-justify">
            <p className="mt-[1.5cm]">
              I am <strong>Valmik Nahata</strong>, an undergraduate student at the <strong>University of California, San Diego</strong>. For the past year, I have focused on developing AI systems that balance power and alignment, with particular emphasis on scaling, robustness through adversarial training and safety mechanisms, and ethical considerations including bias mitigation and transparency—all aimed at accelerating scientific discovery. My research centers on large language models, multimodal AI, and autonomous agents, with specialized work in advanced reasoning techniques (chain-of-thought, tree search), alignment methodologies (RLHF, debate), and inference optimization (quantization).
              <br /><br />
              Originally from New Jersey and now based in California, I maintain strong ties to my New York roots. Beyond my academic pursuits, I enjoy competitive Rubik's cube solving across various sizes (2x2 through 7x7, plus pyraminx, megaminx, and mirror cubes). I also have extensive experience as a violinist, having performed works by Paganini and Bach, with Mendelssohn's Violin Concerto in E Minor remaining my favorite piece. Additionally, I maintain a collection of historical coins dating from the 1800s onward.
            </p>
          </div>
