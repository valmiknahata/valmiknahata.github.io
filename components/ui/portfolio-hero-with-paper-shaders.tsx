        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-14 leading-7 opacity-85 text-justify">
            <p className="mt-[1.5cm]">
              ...
              <br /><br />
              I grew up in Jersey but now call California home—though I'll always be a New Yorker at heart. When I'm not buried in AI work, I'm usually scrambling to solve Rubik's cubes (I've got the full set from 2x2 all the way up to 7x7, plus pyraminx, megaminx, and mirror cubes). I spent years playing violin too, working my way through Paganini's Caprices and Bach's Partitas—my absolute favorite though is still Mendelssohn's Violin Concerto in E Minor. Oh, and for some reason, I've gotten really into collecting old coins, anything from the 1800s and up.
            </p>
          </div>
