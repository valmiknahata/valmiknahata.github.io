          ...
          <div className="mb-6">
            ...
            <div className="space-y-1.5 opacity-80">
              {[
                ...
                { name: "Ethical AI: AI essentials for everyone", desc: "Coursera - University of Cambridge - Credential ID: JA0B4TOIHZ8K", date: "2025" },
                { name: "Generative AI for Healthcare", desc: "Coursera - Google - Credential ID: 0EOTJMTHY3SU", date: "2025" },
                { name: "Lead with Technology and AI", desc: "Coursera - Harvard Business Review - Credential ID: E911L8KUYPHW", date: "2025" },
                { name: "AI Applications in Marketing and Finance", desc: "Coursera - University of Pennsylvania - Credential ID: Y2LRE5OPWR4T", date: "2025" },
                { name: "Agentic AI and AI Agents: A Primer for Leaders", desc: "Coursera - Vanderbilt University - Credential ID: 4NV6TLPYCNGI", date: "2025" },
              ].map((certification) => (
                <div key={certification.name} className="flex flex-row justify-between items-baseline gap-4">
                  <TooltipItem
                    ...
                    className="font-medium shrink"
                  />
                  <span className="opacity-50 tabular-nums shrink-0 text-right">{certification.date}</span>
                </div>
              ))}
            </div>
          </div>
