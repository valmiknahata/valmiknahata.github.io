        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-14 leading-7 opacity-85 text-justify">
            <p className="mt-[1.5cm]">
              ...
              <br /><br />
              I grew up in New Jersey and now live in California, but I'll always be a New Yorker at heart. When I'm not working on AI, you'll find me speedsolving Rubik's cubes—from 2x2 through 7x7, plus pyraminx, megaminx, and mirror cubes. I spent years playing the violin, working through Paganini's Caprices and Bach's Partitas; my favorite piece will always be Mendelssohn's Violin Concerto in E minor. For whatever reason, I've also developed a habit of collecting old coins—especially those from the 1800s onward.
            </p>
          </div>
